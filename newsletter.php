<?php mysql_connect('localhost','newsletterreader','4G3dPHtsPxV8nJj2');
mysql_select_db('owncloud');
$result = mysql_query("SELECT * FROM oc_newsletters WHERE id = $_GET[id]");
$data = mysql_fetch_assoc($result);
$content = json_decode($data['content'], true);

if ( isset($_GET['view']) && $_GET['view'] === 'text' ) { header('Content-Type: text/plain'); ?>
...
<?php } elseif ( isset($_GET['view']) && $_GET['view'] === 'html' ) { ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
	...
	<body style="color:#333333;margin:0;background: #C9C5C4 url('//www.sontia.com/newsletters/images/sparkle3.jpg') 0 0 repeat;font-family: Helvetica, Arial, sans-serif;">
		<table width="100%" cellspacing="0" cellpadding="0" style="background: url('//www.sontia.com/newsletters/images/sparkle3.jpg')" >
			<tbody>
				<tr>
							...
							<tbody>
								<tr>
									<td width="550" cellpadding="0">
										<p style="font-size: 0.8em;margin:0;" align="center">Email not displaying beautifully? <a href="#">View it in your browser</a></p>
									</td>
								</tr>
								...
								<tr>
									<td align="center">
										<p style="margin-top:0;"><a href="https://www.sontia.com">www.sontia.com</a></p>
										<table>
											<tbody align="center" cellpadding="20">
												<tr>
													<td><a href="https://www.facebook.com/SontiaLogic"><img src="https://www.sontia.com/newsletters/images/logo_fb.png" /></a></td>
													<td><a href="https://twitter.com/sontialogic"><img src="https://www.sontia.com/newsletters/images/logo_tw.png" /></a></td>
													<td><a href="https://www.linkedin.com/company/sontia-logic-limited"><img src="https://www.sontia.com/newsletters/images/logo_li.png" /></a></td>
												</tr>
												<tr>
													<td><a href="https://www.facebook.com/SontiaLogic">Facebook</a></td>
													<td><a href="https://twitter.com/sontialogic">Twitter</a></td>
													<td><a href="https://www.linkedin.com/company/sontia-logic-limited">LinkedIn</a></td>
												</tr>
											</tbody>
										</table>
